...
export default function DietaCrescimento() {
  return (
    <>
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cta-primary { display: inline-block; background: #1DB954; color: #0A0A0A; font-family: 'Syne', sans-serif; font-size: .95rem; font-weight: 700; padding: 16px 36px; border-radius: 10px; transition: opacity .15s; border: none; cursor: pointer; }
      ...
      <div className="container">
        ...
        <section className="hero">
          <div className="hero-badge">Dieta Crescimento</div>
          <h1>Você já posta.<br />Hora de <em>escalar.</em></h1>
          <p className="hero-sub">O sistema para lojistas que já têm consistência e querem crescer de verdade — com volume, estratégia e resultado previsível.</p>
          <a href="https://pay.hotmart.com/Q105276202F" className="cta-primary">Quero a Dieta Crescimento →</a>
          <div className="hero-proof">
            <span>R$ 127/mês · Cancele quando quiser · Acesso imediato</span>
          </div>
        </section>
        ...
        <section className="solution-block">
          ...
          <p className="lead">A Dieta Crescimento é um sistema de conteúdo mensal para lojistas e pequenos empresários. Funciona como uma dieta alimentar — você não precisa inventar o que fazer. Só seguir.</p>
        ...
        <section className="forwho-block">
          ...
          <h2>A Dieta Crescimento foi feita para você se...</h2>
        ...
        <section className="price-block">
          ...
          <div className="price-card">
            <div className="price-name">Dieta Crescimento — POSTCAMP</div>
            <div className="price-val"><sup>R$</sup>127<span className="per">/mês</span></div>
            ...
            <div className="cta-block">
              <a href="https://pay.hotmart.com/Q105276202F" className="cta-primary" style={{ width: '100%', textAlign: 'center' }}>Quero a Dieta Crescimento →</a>
        ...
        <section style={{ padding: '3rem 0', textAlign: 'center' }}>
          ...
          <a href="https://pay.hotmart.com/Q105276202F" className="cta-primary">Quero a Dieta Crescimento — R$ 127/mês →</a>
