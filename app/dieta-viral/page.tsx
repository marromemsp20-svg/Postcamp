...
export default function DietaViral() {
  return (
    <>
      <style jsx global>{`
      ...
      <div className="container">
        ...
        <section className="hero">
          <div className="hero-badge">Dieta Viral</div>
          <h1>Pare de travar.<br />Comece a <em>aparecer</em><br />todo dia.</h1>
          <p className="hero-sub">O método para lojistas que não sabem o que postar — e querem crescer no Instagram sem depender de inspiração.</p>
          <a href="https://pay.hotmart.com/K105271539B" className="cta-primary">Quero a Dieta Viral →</a>
          <div className="hero-proof">
            <span>R$ 67/mês · Cancele quando quiser · Acesso imediato</span>
          </div>
        </section>
        ...
        <section className="solution-block">
          ...
          <p className="lead">A Dieta Viral é um sistema de conteúdo mensal para lojistas e pequenos empresários. Funciona como uma dieta alimentar — você não precisa inventar o que fazer. Só seguir.</p>
        ...
        <section className="forwho-block">
          ...
          <h2>A Dieta Viral foi feita para você se...</h2>
        ...
        <section className="price-block">
          ...
          <div className="price-card">
            <div className="price-name">Dieta Viral — POSTCAMP</div>
            <div className="price-val"><sup>R$</sup>67<span className="per">/mês</span></div>
            ...
            <div className="cta-block">
              <a href="https://pay.hotmart.com/K105271539B" className="cta-primary" style={{ width: '100%' }}>Quero a Dieta Viral →</a>
        ...
        <section style={{ padding: '3rem 0', textAlign: 'center' }}>
          ...
          <a href="https://pay.hotmart.com/K105271539B" className="cta-primary">Quero a Dieta Viral — R$ 67/mês →</a>
